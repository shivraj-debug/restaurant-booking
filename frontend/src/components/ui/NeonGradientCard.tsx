...
const NeonGradientCard: React.FC<NeonGradientCardProps> = ({
  ...
  return (
    <Component
      ...
      className={cn(
        "relative z-10 h-full w-full rounded-[var(--border-radius)] p-0 hover:brightness-110 transition-all duration-300",
        className
      )}
      {...props}
    >
      <div
        className={cn(
          "relative h-full min-h-[inherit] w-full rounded-[var(--card-content-radius)] p-0",
